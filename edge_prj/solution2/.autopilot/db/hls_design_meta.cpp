...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("video_address1", 14, hls_out, 0, "ap_memory", "mem_address", 1),
	Port_Property("video_ce1", 1, hls_out, 0, "ap_memory", "mem_ce", 1),
	Port_Property("video_q1", 32, hls_in, 0, "ap_memory", "mem_dout", 1),
	...
	Port_Property("sob_x1_address1", 14, hls_out, 1, "ap_memory", "mem_address", 1),
	Port_Property("sob_x1_ce1", 1, hls_out, 1, "ap_memory", "mem_ce", 1),
	Port_Property("sob_x1_we1", 1, hls_out, 1, "ap_memory", "mem_we", 1),
	Port_Property("sob_x1_d1", 32, hls_out, 1, "ap_memory", "mem_din", 1),
	...
	Port_Property("sob_y1_address1", 14, hls_out, 2, "ap_memory", "mem_address", 1),
	Port_Property("sob_y1_ce1", 1, hls_out, 2, "ap_memory", "mem_ce", 1),
	Port_Property("sob_y1_we1", 1, hls_out, 2, "ap_memory", "mem_we", 1),
	Port_Property("sob_y1_d1", 32, hls_out, 2, "ap_memory", "mem_din", 1),
};
