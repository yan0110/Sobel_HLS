...
; <label>:1                                       ; preds = %12, %0
  %i = phi i7 [ 0, %0 ], [ %i_1, %12 ]
  %phi_mul = phi i14 [ 0, %0 ], [ %next_mul, %12 ]
  ...
  %i_1 = add i7 %i, 1
  br i1 %exitcond3, label %13, label %2
...
; <label>:3                                       ; preds = %11, %2
  ...
  %j_1 = add i7 %j, 1
  br i1 %exitcond2, label %12, label %4
...
; <label>:4                                       ; preds = %3
  ...
  br i1 %or_cond, label %5, label %.preheader.preheader
...
.preheader:                                       ; preds = %.preheader.preheader, %9
  %m = phi i2 [ %m_1, %9 ], [ 0, %.preheader.preheader ]
...
; <label>:2                                       ; preds = %1
  ...
  %tmp_1 = shl i32 %operatr_load, 2
  %tmp_16 = sub i32 %tmp_1, %operatr_load
  %tmp_17 = mul i32 %block_load, %tmp_16
  %value_2 = add i32 %tmp_17, %value
  br label %1
...
entry:
  ...
  %empty_11 = trunc i14 %empty to i12
  ret i12 %empty_11
}
...
entry:
  ...
  %empty_15 = zext i2 %1 to i14
  %empty_16 = shl i14 %empty, 2
  %empty_17 = or i14 %empty_16, %empty_15
  ret i14 %empty_17
}
