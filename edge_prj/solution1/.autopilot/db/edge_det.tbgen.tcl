set C_TypeInfoList {{ 
"edge_det" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"video": [[], {"array": [ {"scalar": "int"}, [10000]]}] }, {"sob_x1": [[], {"array": [ {"scalar": "int"}, [10000]]}] }, {"sob_y1": [[], {"array": [ {"scalar": "int"}, [10000]]}] }, {"sob_xy1": [[], {"array": [ {"scalar": "int"}, [10000]]}] }],[],""]
}}
...
set C_modelArgList {
	...
	{ sob_xy1 int 32 regular {array 10000 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "video", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "video","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 9999,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "sob_xy1", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "sob_xy1","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 9999,"step" : 1}]}]}]} ]}
...
set portList { 
	...
	{ sob_xy1_address0 sc_out sc_lv 14 signal 3 } 
	{ sob_xy1_ce0 sc_out sc_logic 1 signal 3 } 
	{ sob_xy1_we0 sc_out sc_logic 1 signal 3 } 
	{ sob_xy1_d0 sc_out sc_lv 32 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sob_xy1_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "sob_xy1", "role": "address0" }} , 
 	{ "name": "sob_xy1_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "sob_xy1", "role": "ce0" }} , 
 	{ "name": "sob_xy1_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "sob_xy1", "role": "we0" }} , 
 	{ "name": "sob_xy1_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sob_xy1", "role": "d0" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5"],
		...
		"VariableLatency" : "1",
		"WaitState" : [
			{"State" : "ap_ST_fsm_state7", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_convolution_fu_207"},
			{"State" : "ap_ST_fsm_state9", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_convolution_fu_207"}],
		"Port" : [
			{"Name" : "video", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "sob_x1", "Type" : "Memory", "Direction" : "O"},
			{"Name" : "sob_y1", "Type" : "Memory", "Direction" : "O"},
			{"Name" : "sob_xy1", "Type" : "Memory", "Direction" : "O"},
			{"Name" : "sob_x", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "grp_convolution_fu_207", "Port" : "operatr"}]},
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_convolution_fu_207", "Parent" : "0",
		"CDFG" : "convolution",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"FunctionPipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"Combinational" : "0",
	...
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.edge_det_ama_addmbkb_U3", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	edge_det {
		...
		sob_xy1 {Type O LastRead -1 FirstWrite 6}
...
set Spec2ImplPortList { 
	...
	sob_xy1 { ap_memory {  { sob_xy1_address0 mem_address 1 14 }  { sob_xy1_ce0 mem_ce 1 1 }  { sob_xy1_we0 mem_we 1 1 }  { sob_xy1_d0 mem_din 1 32 } } }
}
