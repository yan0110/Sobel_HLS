...
#ifndef __edge_det_ama_addmbkb__HH__
#define __edge_det_ama_addmbkb__HH__
...
template<
    ...
    int din3_WIDTH,
    int dout_WIDTH>
SC_MODULE(edge_det_ama_addmbkb) {
    ...
    SC_CTOR(edge_det_ama_addmbkb):  simcore_ama_0_U ("simcore_ama_0_U") {
