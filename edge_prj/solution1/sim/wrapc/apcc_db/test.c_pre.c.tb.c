...
static  char aesl_internal__OC_str[7] = "in.txt";
...
llvm_cbe_tmp__25:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge5 = phi i32 [ 0, %%0 ], [ %%7, %%2  for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_storemerge5_count);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__3);
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = sext i32 %%storemerge5 to i64, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_32_count);
  llvm_cbe_tmp__4 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge5);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__4);
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = getelementptr inbounds [10000 x i32]* %%a, i64 0, i64 %%5, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_33_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%4, i32* %%6, align 4, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_34_count);
  *llvm_cbe_tmp__5 = llvm_cbe_tmp__3;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__3);
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = add nsw i32 %%storemerge5, 1, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_35_count);
  llvm_cbe_tmp__6 = (unsigned int )((unsigned int )(llvm_cbe_storemerge5&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__6&4294967295ull)));
  if (((llvm_cbe_tmp__6&4294967295U) == (10000u&4294967295U))) {
    goto llvm_cbe_tmp__26;
  } else {
    llvm_cbe_storemerge5__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__6;   /* for PHI node */
    goto llvm_cbe_tmp__25;
  }
...
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = getelementptr inbounds [10000 x i32]* %%a, i64 0, i64 10000, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_48_count);
  llvm_cbe_tmp__8 = (signed int *)(&llvm_cbe_a[(((signed long long )10000ull))
#ifdef AESL_BC_SIM
 % 10000
#endif
]);
...
#ifdef AESL_BC_SIM
  if (!(((signed long long )10000ull) < 10000)) fprintf(stderr, "%s:%d: warning: Read access out of array 'a' bound?\n", __FILE__, __LINE__);

#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = load i32* %%10, align 16, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_49_count);
  llvm_cbe_tmp__9 = (unsigned int )*llvm_cbe_tmp__8;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = call i32 bitcast (i32 (...)* @edge to i32 (i32, i32, i32)*)(i32 %%11, i32 undef, i32 undef) nounwind, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_50_count);
  edge(llvm_cbe_tmp__9, ((unsigned int )/*UNDEF*/0), ((unsigned int )/*UNDEF*/0));
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = call %%struct._iobuf* @fopen(i8* getelementptr inbounds ([16 x i8]* @aesl_internal_.str3, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8]* @aesl_internal_.str4, i64 0, i64 0)) nounwind, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_51_count);
  llvm_cbe_tmp__11 = (l_struct_OC__iobuf *)aesl_fopen(( char *)((&aesl_internal__OC_str3[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 16
#endif
...
llvm_cbe_tmp__27:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge14 = phi i32 [ 0, %%8 ], [ %%19, %%14  for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_storemerge14_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = sext i32 %%storemerge14 to i64, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_70_count);
  llvm_cbe_tmp__12 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge14);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__12);
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = getelementptr inbounds [10000 x i32]* %%sob_x1out, i64 0, i64 %%15, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_71_count);
  llvm_cbe_tmp__13 = (signed int *)(&llvm_cbe_sob_x1out[(((signed long long )llvm_cbe_tmp__12))
#ifdef AESL_BC_SIM
 % 10000
#endif
]);
...
#ifdef AESL_BC_SIM
  if (!(((signed long long )llvm_cbe_tmp__12) < 10000)) fprintf(stderr, "%s:%d: warning: Read access out of array 'sob_x1out' bound?\n", __FILE__, __LINE__);

#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = load i32* %%16, align 4, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_72_count);
  llvm_cbe_tmp__14 = (unsigned int )*llvm_cbe_tmp__13;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__14);
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = call i32 (%%struct._iobuf*, i8*, ...)* @fprintf(%%struct._iobuf* %%13, i8* getelementptr inbounds ([4 x i8]* @aesl_internal_.str5, i64 0, i64 0), i32 %%17) nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_73_count);
  fprintf((l_struct_OC__iobuf *)llvm_cbe_tmp__11, ( char *)((&aesl_internal__OC_str5[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 4
#endif
])), llvm_cbe_tmp__14);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%19 = add nsw i32 %%storemerge14, 1, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_74_count);
  llvm_cbe_tmp__16 = (unsigned int )((unsigned int )(llvm_cbe_storemerge14&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__16&4294967295ull)));
  if (((llvm_cbe_tmp__16&4294967295U) == (10000u&4294967295U))) {
    goto llvm_cbe_tmp__28;
  } else {
    llvm_cbe_storemerge14__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__16;   /* for PHI node */
    goto llvm_cbe_tmp__27;
  }
...
llvm_cbe_tmp__28:
if (AESL_DEBUG_TRACE)
printf("\n  %%21 = call i32 @fclose(%%struct._iobuf* %%13) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_86_count);
  fclose((l_struct_OC__iobuf *)llvm_cbe_tmp__11);
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__17);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%22 = call %%struct._iobuf* @fopen(i8* getelementptr inbounds ([16 x i8]* @aesl_internal_.str6, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8]* @aesl_internal_.str4, i64 0, i64 0)) nounwind, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_87_count);
  llvm_cbe_tmp__18 = (l_struct_OC__iobuf *)aesl_fopen(( char *)((&aesl_internal__OC_str6[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 16
#endif
])), ( char *)((&aesl_internal__OC_str4[(((signed long long )0ull))
...
llvm_cbe_tmp__29:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge23 = phi i32 [ 0, %%20 ], [ %%28, %%23  for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_storemerge23_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%24 = sext i32 %%storemerge23 to i64, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_106_count);
  llvm_cbe_tmp__19 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge23);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__19);
if (AESL_DEBUG_TRACE)
printf("\n  %%25 = getelementptr inbounds [10000 x i32]* %%sob_y1out, i64 0, i64 %%24, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_107_count);
  llvm_cbe_tmp__20 = (signed int *)(&llvm_cbe_sob_y1out[(((signed long long )llvm_cbe_tmp__19))
#ifdef AESL_BC_SIM
 % 10000
#endif
]);
...
#ifdef AESL_BC_SIM
  if (!(((signed long long )llvm_cbe_tmp__19) < 10000)) fprintf(stderr, "%s:%d: warning: Read access out of array 'sob_y1out' bound?\n", __FILE__, __LINE__);

#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%26 = load i32* %%25, align 4, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_108_count);
  llvm_cbe_tmp__21 = (unsigned int )*llvm_cbe_tmp__20;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__21);
if (AESL_DEBUG_TRACE)
printf("\n  %%27 = call i32 (%%struct._iobuf*, i8*, ...)* @fprintf(%%struct._iobuf* %%22, i8* getelementptr inbounds ([4 x i8]* @aesl_internal_.str5, i64 0, i64 0), i32 %%26) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_109_count);
  fprintf((l_struct_OC__iobuf *)llvm_cbe_tmp__18, ( char *)((&aesl_internal__OC_str5[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 4
#endif
])), llvm_cbe_tmp__21);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%28 = add nsw i32 %%storemerge23, 1, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_110_count);
  llvm_cbe_tmp__23 = (unsigned int )((unsigned int )(llvm_cbe_storemerge23&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__23&4294967295ull)));
  if (((llvm_cbe_tmp__23&4294967295U) == (10000u&4294967295U))) {
    goto llvm_cbe_tmp__30;
  } else {
    llvm_cbe_storemerge23__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__23;   /* for PHI node */
    goto llvm_cbe_tmp__29;
  }
...
llvm_cbe_tmp__30:
if (AESL_DEBUG_TRACE)
printf("\n  %%30 = call i32 @fclose(%%struct._iobuf* %%22) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_122_count);
  fclose((l_struct_OC__iobuf *)llvm_cbe_tmp__18);
if (AESL_DEBUG_TRACE) {
